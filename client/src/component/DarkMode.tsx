    ...
    <div className="flex flex-col justify-end  h-full gap-4 relative w-full">
      ...
      <div className="flex gap-10 justify-center">
        <button
          ...
          className="py-2 px-10  bg-white focus:outline-none border-black border rounded-md  text-black w-1/3 "
        >
          light
        </button>
        <button
          onClick={(e) => changeDisplay("light")}
          className="py-2 px-10 bg-[#15202B] focus:outline-none hover:outline-none hover:border-white hover:bg-[#0f1923] border rounded-md text-black w-1/3"
        >
          dark
        </button>
      </div>
