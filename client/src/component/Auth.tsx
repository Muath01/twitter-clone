...
function Auth() {
  ...
  async function handleSubmit(e: any) {
    ...
    try {
      ...
      console.log("logged in succefully: ", currentUser);
    ...
    <div className="bg-[#15202B] w-full  h-[100%] flex justify-center items-center bg-opacity-30 ">
      <div className="flex items-center justify-center h-5/6 w-1/2 shadow-2xl bg-[#15202B] backdrop-blur-0 ">
        <div className=" h-3/4 flex flex-col w-full sm:w-5/6 md:w-4/5 lg:w-3/4 xl:w-1/2 items-start px-9 py-10  gap-2 mt-10">
          ...
          <button className="rounded-full bg-white py-2 w-full my-3 focus:outline-none text-black">
            <i className="fa-brands fa-google mr-2 text-black"></i>Sign in with
            google
          </button>
          <button className="rounded-full bg-white py-2 w-full focus:outline-none text-black">
            <i className="fa-brands fa-apple mr-2 text-black"></i> Sign in with
            Apple
          </button>
          ...
          <div className="w-full">
            {isVisible ? (
              ...
              <form onSubmit={handleSubmit}>
                <div
                  // ref={inputRef}
                  className="w-full bg-[#15202B] pt-2 p-0 flex justify-end flex-col  rounded-sm relative"
                >
                  {/* Login */}
                  ...
                  <div className=" w-full absolute mb-10 top-[11rem] left-0 ">
                    <button className="border  rounded-full w-full py-1.5 text-white font-bold focus:outline-none ">
                      Log in
                    </button>
                  </div>
                </div>
